      ...
      {openTabs.map((tab) => {
        ...
        return (
          <div
            ...
            className={`group flex items-center gap-2 px-3 h-full text-[13px] cursor-pointer border-r border-[var(--vscode-border)] shrink-0 select-none transition-colors ${
              isActive
          ...
          >
            ...
            <button
              ...
              className="ml-1 p-0.5 rounded-sm opacity-0 group-hover:opacity-100 hover:bg-[var(--vscode-line-highlight)] transition-opacity"
            >
              <X size={14} />
            </button>
          </div>
